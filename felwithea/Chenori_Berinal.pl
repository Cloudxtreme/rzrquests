...
sub EVENT_SAY {
  ...
  if($text=~/hail/i) {
    quest::say("Hello, $name. Feel free to browse my wares.");
    # Unless you are looking to make a special Feir`Dal robe. If so, just let me know that you want a [robe pattern]."); #Still need real text
  }
