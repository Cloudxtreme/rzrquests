...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Hello, $name, are you new to this house? I do not believe we have ever met before. Allow me to introduce myself, I am Alimaja Shanthun High Priest of Erudin.");
    #If you are a [cleric] I believe I might be able to help you.");
  }
  #if ($text=~/cleric/i) {
