...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("Good day, $name, is there something I can help you with?");
    #I am currently training young paladins the way of our house so if you are a [paladin] perhaps we can start you off on the right path.");
  }
  # if ($text=~/paladin/i) {
