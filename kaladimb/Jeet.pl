...
sub EVENT_ITEM {
   if (plugin::check_handin(\%itemcount, 13054 => 4)) { # Giant Rat Pelt
      ...
      quest::exp(5000);
      quest::summonitem(quest::ChooseRandom(2108,2124,2118,2116,2120,2123)); # Patchwork gear
     }
      ...
      quest::summonitem(quest::ChooseRandom(10009, 10015, 10500)); # Bead Necklace, Malachite, Small Piece of Ore
   }
      ...
      quest::faction(90, -10); # Ebon Mask
      quest::exp(5000);
      quest::summonitem(10005); # Silver Stud
   }
