function event_say(e)
	...
	-- 		e.self:SummonItem(17261); -- Fistfighters Sewing Kit ID-17261
	...
	-- 		e.self:SummonItem(22583); -- An Enchanted Cap Pattern ID-22583
	...
	-- 		e.self:SummonItem(22584); -- An Enchanted Bracer Pattern ID-22584
	...
	-- 		e.self:SummonItem(22586); --  An Enchanted Sleeves Pattern ID-22586
	...
	-- 		e.self:SummonItem(22585); -- An Enchanted Sandals Pattern ID-22585
	...
	-- 		e.self:SummonItem(22587); -- An Enchanted Trousers Pattern ID-22587
	...
	-- 		e.self:SummonItem(22588); -- An Enchanted Gloves Pattern ID-22588
	...
	-- 		e.self:SummonItem(22589); -- An Enchanted Robe Pattern ID-22589
