...
function event_trade(e)
	...
	-- elseif (item_lib.check_turn_in(e.trade, {item1 = 13782,item2 = 13782,item3 = 13782, item4 = 10307})) then -- ruined wolf pelt x3 and fire beetle eye
	-- 	e.self:Say("Dats gud, here take dis armor to helps you be stronger. Come sees me when you want [another] job");
	-- 	e.other:SummonItem(2104); -- patchwork tunic
	-- 	e.other:Ding();
	-- 	e.other:AddEXP(1000);
	-- elseif (item_lib.check_turn_in(e.trade, {item1 = 13088, item2 = 13088})) then -- snake egg x2
