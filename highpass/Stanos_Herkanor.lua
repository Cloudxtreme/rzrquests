...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 28010,item2 = 28011})) then -- Stained Parchment Top, Stained Parchment Bottom
		...
		e.other:SummonItem(28012); -- Combined Parchment
		e.other:Ding();
		...
		e.other:AddEXP(500);
		eq.depop();
	elseif(item_lib.check_turn_in(e.trade, {item1 = 28013,item2 = 7506,item3 = 7505})) then -- General's Pouch, Jagged Diamond Dagger, Cazic Quill
		...
		e.other:SummonItem(11057); -- Ragebringer
		e.other:Ding();
		e.other:Faction(149,5,0);
		e.other:Faction(31,10,0);
		e.other:Faction(214,5,0);
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 18961})) then -- Translated Parchment
		...
		e.other:SummonItem(28057); -- Sealed Box
		e.other:Ding();
		e.other:Faction(149,5,0);
		e.other:Faction(31,10,0);
		e.other:Faction(214,5,0);
